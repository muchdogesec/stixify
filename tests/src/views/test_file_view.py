...
def test_list_attack_navigator__has_data(client, stixify_file, api_schema, navigator_data):
    ...
    resp = client.get(
        "/api/v1/files/dcbeb240-8dd6-4892-8e9e-7b6bda30e454/attack-navigator/",
        data=None,
        content_type="application/json",
    )
    assert resp.status_code == 200, resp.content
...
def test_retrieve_attack_navigator__no_data(client, stixify_file, api_schema):
    ...
    resp = client.get(
        "/api/v1/files/dcbeb240-8dd6-4892-8e9e-7b6bda30e454/attack-navigator/ics/",
        data=None,
        content_type="application/json",
    )
    assert resp.status_code == 404, resp.content
    ...
    api_schema["/api/v1/files/{file_id}/attack-navigator/{attack_domain}/"][
        "GET"
    ].validate_response(Transport.get_st_response(resp))
...
def test_retrieve_attack_navigator__has_data(
    ...
    resp = client.get(
        f"/api/v1/files/dcbeb240-8dd6-4892-8e9e-7b6bda30e454/attack-navigator/ics/",
        data=None,
        content_type="application/json",
    )
    assert resp.status_code == 200, resp.content
    ...
    resp = client.get(
        f"/api/v1/files/dcbeb240-8dd6-4892-8e9e-7b6bda30e454/attack-navigator/mobile/",
        data=None,
        content_type="application/json",
    )
    assert resp.status_code == 200, resp.content
    ...
    resp = client.get(
        f"/api/v1/files/dcbeb240-8dd6-4892-8e9e-7b6bda30e454/attack-navigator/enterprise/",
        data=None,
        content_type="application/json",
    )
    assert resp.status_code == 404, resp.content
