...
def test_list_attack_navigator__has_data(client, stixify_file, api_schema, navigator_data):
    ...
    resp = client.get(
        "/api/v1/reports/report--dcbeb240-8dd6-4892-8e9e-7b6bda30e454/attack-navigator/",
        data=None,
        content_type="application/json",
    )
    assert resp.status_code == 200, resp.content
    assert resp.data == {"ics": True, "mobile": True, "enterprise": False}
    api_schema["/api/v1/reports/{report_id}/attack-navigator/"][
        "GET"
    ].validate_response(Transport.get_st_response(resp))


@pytest.mark.django_db
def test_retrieve_attack_navigator__no_data(client, stixify_file, api_schema):
    post = models.File.objects.get(pk="dcbeb240-8dd6-4892-8e9e-7b6bda30e454")
    post.txt2stix_data = {}
    post.save()

    resp = client.get(
        "/api/v1/reports/report--dcbeb240-8dd6-4892-8e9e-7b6bda30e454/attack-navigator/ics/",
        data=None,
        content_type="application/json",
    )
    ...
    api_schema["/api/v1/reports/{report_id}/attack-navigator/{attack_domain}/"][
        "GET"
    ].validate_response(Transport.get_st_response(resp))
...
def test_retrieve_attack_navigator__has_data(
    client, stixify_file, api_schema, navigator_data
):
    post = models.File.objects.get(pk="dcbeb240-8dd6-4892-8e9e-7b6bda30e454")
    ...
    resp = client.get(
        f"/api/v1/reports/report--dcbeb240-8dd6-4892-8e9e-7b6bda30e454/attack-navigator/ics/",
        data=None,
        content_type="application/json",
    )
    assert resp.status_code == 200, resp.content
    ...
    resp = client.get(
        f"/api/v1/reports/report--dcbeb240-8dd6-4892-8e9e-7b6bda30e454/attack-navigator/mobile/",
        data=None,
        content_type="application/json",
    )
    assert resp.status_code == 200, resp.content
    ...
    resp = client.get(
        f"/api/v1/reports/report--dcbeb240-8dd6-4892-8e9e-7b6bda30e454/attack-navigator/enterprise/",
        data=None,
        content_type="application/json",
    )
    assert resp.status_code == 404, resp.content
