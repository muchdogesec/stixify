...
class FileSerializer(serializers.ModelSerializer):
    ...
    labels = CharacterSeparatedField(required=False, help_text="Labels must contain only lowercase letters, numbers, and hyphens. Separate multiple labels with commas.", child=serializers.SlugField(max_length=256), max_length=32)
